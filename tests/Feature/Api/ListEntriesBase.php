...
class ListEntriesBase extends TestCase {
     ...
     * @return Collection
     */
    protected function batch_generate_entries(int $generate_entry_count, int $generated_account_type_id, array $filter_details=[], bool $randomly_mark_entries_disabled=false, bool $mark_entries_disabled=false){
