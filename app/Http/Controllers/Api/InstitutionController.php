...
class InstitutionController extends Controller {
     ...
     */
    public function disabledInstitution(int $institutionId): Response {
        try {
    ...
    /**
     * GET /api/institution/{instituion_id}
     * GET /api/institute/{instituion_id}
     */
    public function get_institution(int $institution_id): Response {
        try {
            $institution = Institution::withTrashed()
                ->with(Account::getTableName(), function($institution_account) {
                    return $institution_account->withTrashed();
