            ...
            <section class="modal-card-body">
                ...
                <div class="field">
                    <div class="control has-text-centered">
                      <ToggleButton
                          button-name="entry-expense"
                          class="expense-income-toggle"
                          v-model:toggle-state="entryData.expense"
                          v-bind:is-disabled="isLocked"
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body"><div class="field"><div class="control" v-bind:class="{'is-loading': !areTagsSet}">
                      <TagsInput v-show="!isLocked"
                         v-model:tags-input="entryData.tags"
    ...
    export default {
        ...
        methods: {
            ...
            resetEntryData: function(){
              this.$eventBus.broadcast(this.$eventBus.EVENT_FILE_DROP_UPDATE(), {modal: 'entry-modal', task: 'enable'});
              this.$eventBus.broadcast(this.$eventBus.EVENT_FILE_DROP_UPDATE(), {modal: 'entry-modal', task: 'clear'});
        ...
        created: function(){
          this.$eventBus.listen(this.$eventBus.EVENT_ENTRY_MODAL_OPEN(), this.primeDataForModal);
          this.$eventBus.listen(this.$eventBus.EVENT_ENTRY_MODAL_UPDATE_DATA(), this.openModal);
          this.$eventBus.listen(this.$eventBus.EVENT_ENTRY_MODAL_CLOSE(), this.closeModal);
        },
        mounted: function(){
            this.resetEntryData();
        }
