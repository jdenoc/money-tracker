<template>
  <div class="existing-attachment flex justify-between p-2 mb-2 rounded border-t border-gray-100 shadow-md">
    ...
    <div class="flex">
      ...
      <button type="button" class="delete-attachment inline-flex justify-center rounded-md border border-gray-300 px-3 py-2 bg-red-600 text-white opacity-95 hover:opacity-100 disabled:opacity-40"
