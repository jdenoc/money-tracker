...
export class Accounts extends ObjectBaseClass {
  ...
  getInstitution(accountId){
    ...
    if(Object.prototype.hasOwnProperty.call(account, 'institution_id')){
  ...
  getAccountTypes(accountId){
    ...
    return new AccountTypes().retrieve.filter(function(accountType){
      return Object.prototype.hasOwnProperty.call(accountType, 'account_id')
              && accountId === accountType.account_id;
    });
  }
}